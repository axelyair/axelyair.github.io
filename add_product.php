...
<?php
 if(isset($_POST['add_product'])){
   $req_fields = array('product-title','product-categorie','product-client','product-quantity','buying-price', 'saleing-price' );
   validate_fields($req_fields);
   if(empty($errors)){
     $p_name  = remove_junk($db->escape($_POST['product-title']));
     $p_cat   = remove_junk($db->escape($_POST['product-categorie']));
     $p_cli   = remove_junk($db->escape($_POST['product-client']));
     ...
     $query .=" name,quantity,sale_price,categorie_id,media_id,date";
     $query .=") VALUES (";
